...
# общий код двух мастеров (Windows и macOS) — setup_common.py
from setup_common import (LANGS, LANG_NAMES, NET_TIMEOUT, RAW_BASE, RELEASE_URL, REPO,  # noqa: F401
                          _ssl_contexts, _urlopen, db_rows, dir_writable, download_to,
                          file_info, http_get, load_release, merge_companies, sha256_of,
                          ver_tuple)
