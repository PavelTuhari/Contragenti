...
| **[ARTICLE_AI_ru.md](ARTICLE_AI_ru.md)** | **Статья:** Delphi, Oracle и C++ под управлением ИИ — разбор проекта как образца для похожих ([HTML](docs/article-ai-delphi-oracle-cpp.html)) |
