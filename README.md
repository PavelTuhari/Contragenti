...
installation» его не касается). Тихо: `Contragenti-1.3.3-setup.exe /S`,
портативно: `--extract-only D:\Contragenti`.

Второй вариант — MSI: [Contragenti-1.3.3-win64.msi](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.3-win64.msi).
Рядом — [Contragenti-update-1.3.3.zip](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-update-1.3.3.zip):
...
> сверить по sha256 из `release.json`: `Get-FileHash .\Contragenti-1.3.3-setup.exe`.
