...
1. Скачайте установщик из репозитория:
   **[release/Contragenti-1.3.6-setup.exe](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.6-setup.exe)**
   (обычный exe без Windows Installer; если у вас в организации ставят
   только MSI — [Contragenti-1.3.6-win64.msi](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.6-win64.msi);
   рядом лежит `Contragenti-update-1.3.6.zip` — пакет обновления, его
   ...
   `Contragenti-1.3.6-setup.exe /D=%LOCALAPPDATA%\Contragenti`). В установке уже
