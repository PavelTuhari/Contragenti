...
|---|---|---|---|---|---|---|---|---|---|
| 17 | 20 | 12 | 22 | 21 | 23 | 41 | 124 (24 + 100 по проектам) | 10 | 0 (`admin/admin` создаётся при первом старте GUI, когда таблица пуста) |
...
(задач по проектам 100)`. Эталоны других режимов — `crm_delphi/st.log`
