...
Режимы:
    Contragenti-1.3.2-setup.exe                 окно (каталог, ярлыки, язык)
    Contragenti-1.3.2-setup.exe /S              тихо в %LOCALAPPDATA%\\Contragenti
    Contragenti-1.3.2-setup.exe /S /D=C:\\Dir     тихо в указанный каталог
    Contragenti-1.3.2-setup.exe --extract-only C:\\Dir
