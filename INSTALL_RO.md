...
[Contragenti-1.3.7-win64.msi](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.7-win64.msi)
...
```powershell
.\Contragenti-1.3.7-setup.exe /S
.\Contragenti-1.3.7-setup.exe /S /D=D:\Contragenti --no-wizard
```
...
| Simptom | Ce faceți |
|---|---|
| „The system administrator has set policies to prevent this installation” | Este politica MSI (cod 1625). Folosiți `Contragenti-1.3.7-setup.exe` |
