...
**[Contragenti-1.3.5-setup.exe](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.5-setup.exe)**
(câțiva MB, fără Windows Installer — funcționează și acolo unde MSI este
interzis prin politică). **Necesită internet în timpul instalării** — descarcă
automat sursa completă din github.com/PavelTuhari/Contragenti și îi verifică
suma de control (sha256) înainte de dezarhivare.
...
Alternativă pentru medii fără internet la instalare sau cu MSI obligatoriu:
[Contragenti-1.3.5-win64.msi](https://github.com/PavelTuhari/Contragenti/raw/main/release/Contragenti-1.3.5-win64.msi)
(≈40 MB, conține tot ce e necesar — nu descarcă nimic în timpul instalării;
...
```powershell
.\Contragenti-1.3.5-setup.exe /S
.\Contragenti-1.3.5-setup.exe /S /D=D:\Contragenti --no-wizard
```
...
| Simptom | Ce faceți |
|---|---|
| „The system administrator has set policies to prevent this installation” | Este politica MSI (cod 1625). Folosiți `Contragenti-1.3.5-setup.exe` |
